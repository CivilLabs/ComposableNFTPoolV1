 ...
 */
contract ERC1155Q is Context, ERC165, IERC1155 {
    ...
    mapping(uint256 => uint32) private _totalSupply;
    ...
    constructor(
        ...
        require(collectionSize_ > 0,"Collection Size(num of Quarks) should be positive");
    ...
    function totalSupply(uint256 tokenId) external view returns(uint32){
